...
const ConfirmatioDatasetAnalyseDelete: React.FC<ConfirmationModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  idProjet,
    ...
    <Modal show={isOpen} onHide={onClose} centered>
      ...
      <Modal.Body>
        ...
        <p style={{ textAlign: "center" }}>
          Vous êtes sur le point d'archiver le dataset de analyse {idAnalyse}{" "}
          <br /> du projet {idProjet}, êtes-vous sûr ?
        </p>
      </Modal.Body>
...
export default ConfirmatioDatasetAnalyseDelete;